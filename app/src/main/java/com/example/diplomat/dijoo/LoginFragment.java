...
/**
 * Created by Diplomat on 4/6/2016.
 */
     ...
     * {@link com.example.diplomat.dijoo.TwitterOAuthActivity}
     ...
     */
    public class LoginFragment extends HomeActivity implements
            ...
            AsyncTask<Void, Void, String> task = new AsyncTask<Void, Void, String>() {
                ...
                protected String doInBackground(Void... params) {
                    ...
                    try {
                        ...
                        token = GoogleAuthUtil.getToken(LoginFragment.this, Plus.AccountApi.getAccountName(mGoogleApiClient), scope);
